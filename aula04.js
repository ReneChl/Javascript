...
var salario = 5046
var retornoSalario = `A profissão dele é ${profissao} e ele recebe ao mês ${salario} reais`;
...
var raca = "Caramelo";
var idade = 3;
var retornoRaca = `A raça dele é ${raca} ele tem ${idade} anos`;
console.log(retornoRaca);