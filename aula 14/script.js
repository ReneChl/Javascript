const input = documento.getElementeById("tasInput");// guarda informacão
...
function addTask() {// adiciona tarefa,aqui estamos criando uma função para ser atribuída dentro do botão "adicionada".
    ...
    imput.value = ""; // usado para limpar o input, depois  de add o item em questão. deja campo vacio
